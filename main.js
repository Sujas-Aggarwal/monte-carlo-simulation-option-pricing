...
var _calculateCallOption = (Module["_calculateCallOption"] =
  createExportWrapper("calculateCallOption", 6));
var _calculatePutOption = (Module["_calculatePutOption"] = createExportWrapper(
  "calculatePutOption",
  6
));
...
Module.onRuntimeInitialized = () => {
  ...
  const calculateCallOption = Module.cwrap("calculateCallOption", "number", [
    "number",
    "number",
    "number",
    "number",
  ...
  const calculatePutOption = Module.cwrap("calculatePutOption", "number", [
    "number",
    "number",
    "number",
    "number",
  ...
  function calculate() {
    ...
    let sigma = 0.2;
    let T = 1.0;
    let numSimulations = 100000;
    S0 = document.querySelector("#initialStockPrice").value;
    K = document.querySelector("#strikePrice").value;
    r = document.querySelector("#riskFreeRate").value;
    sigma = document.querySelector("#volatility").value;
    T = document.querySelector("#timeToMaturity").value;
    numSimulations = document.querySelector("#numSimulations").value;
    const callPrice = calculateCallOption(S0, K, r, sigma, T, numSimulations);
